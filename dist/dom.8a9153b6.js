...
window.dom = {
    create: function create(string) {
        var container = document.createElement("template"); //template可以容纳任意元素
    ...
    wrap: function wrap(node, parent) {
        dom.before(node, parent); //先把新增的爸爸节点，放到老节点的前面
        dom.append(parent, node); //再把老节点放入新爸爸的里面 
    },
...
//# sourceMappingURL=/dom.8a9153b6.map